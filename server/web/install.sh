...
cp client.py /usr/bin/serverstatusclient.py
chmod +x /usr/bin/serverstatusclient.py

echo "nohup /usr/bin/serverstatusclient.py & > /dev/null 2>&1" > /etc/rc.local
nohup /usr/bin/serverstatusclient.py & > /dev/null 2>&1